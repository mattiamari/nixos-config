...
stdenv.mkDerivation (finalAttrs: {
  ...
  patches = [
    ...
    # AVFrame::interlaced_frame removed in FFmpeg 6.1
    ./fix-ffmpeg-interlaced.patch
    # Qt6 QPA headers require GuiPrivate link target
    ./fix-qt-private-headers.patch
  ];
  ...
  cmakeFlags = [
    ...
    (lib.cmakeFeature "SPIRV-Headers_SOURCE_DIR" "${src}/externals/SPIRV-Headers")
